...
const MENU_ITEMS = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10a2 2 0 01-2 2h-2a2 2 0 01-2-2zm9-1h-2a2 2 0 00-2 2v3a2 2 0 002 2h2a2 2 0 002-2v-3a2 2 0 00-2-2z" />
      </svg>
    )
  },
  {
        ...
        {MENU_ITEMS.map((item) => {
          ...
          return (
            <Link
              ...
              `}
            >
              <span className={isActive ? 'text-amber-500' : 'text-gray-500 group-hover:text-gray-300'}>
                {item.icon}
              </span>
              {item.label}
            </Link>
